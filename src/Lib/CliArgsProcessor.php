...
final class CliArgsProcessor {
	...
	private const LONG_OPTS  = ['pid:', 'pid-file:', 'host::', 'port::', 'disable-telemetry', 'help'];
	private const DEFAULT_OPTS = ['host' => '127.0.0.1', 'port' => 5000];

	/**
	 * @param array{
	 * host:string,port:string,pid:?string,pid-file:?string,port:?int,disable-telemetry?:bool,help?:bool
	 * } $opts
	 * @return string
	 */
