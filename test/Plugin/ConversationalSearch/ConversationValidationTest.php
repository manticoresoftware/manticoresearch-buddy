...
class ConversationValidationTest extends TestCase {
	...
	public function testDescriptionFieldIsAccepted(): void {
		...
		$this->assertSame('Test chat Model', $payload->params['description']);
	}
	...
	public function testValidTimeoutEdgeCases(): void {
		$query1 = "CREATE CHAT MODEL 'test_model1' (
			model = 'openai:gpt-4',
			timeout = 1
		)";

		$payload1 = ChatPayload::fromRequest(
			Request::fromArray(
				[
				'version' => Buddy::PROTOCOL_VERSION,
				'error' => '',
		...
		$query2 = "CREATE CHAT MODEL 'test_model2' (
			model = 'openai:gpt-4',
			timeout = 65536
		)";

		$payload2 = ChatPayload::fromRequest(
			Request::fromArray(
				[
				'version' => Buddy::PROTOCOL_VERSION,
				'error' => '',
